        ...
        <div class="information-boxes module">
            <div class="newadmission-info medium-4 small-12 columns">
                <div class="">
                    ...
                    <p>
                    Encouragers High School, Ojoto is committed to provide maximum educational room for all student, to enable them build a brighter future for themselves through stimulating academic forum to meet up to current status  Via combined effort of the staff and students
                    </p>
            ...
            <div class="courses-info medium-4 small-12 columns">
                <div class="">
                    ...
                    <p>
                        The curriculum of Encouragers High School, Ojoto is designed to take care of the Interest of students from all parts of the world. The school operates basically Nigerian curriculum but patterned to suit students from any other Part of the world.
                        Encouragers High School, Ojoto has a high policy on academic standards and its students
                    </p>
                    <div class="clearfix"></div>
